...
$html .= '<h5><font face="Century Gothic" color="#0088cc">nameString</font></h5>';
...
if (strlen($search_string) >= 1 && $search_string !== ' ') {
	...
	if (isset($result_array)) {
		foreach ($result_array as $result) {
			...
			$display_name = preg_replace("/".$search_string."/i", "<b class='highlight'>".$search_string."</b>", $result['judul']);
			
			$display_id = preg_replace("/".$search_string."/i", "<b class='highlight'>".$search_string."</b>", $result['id']);
		...
		$output = str_replace('nameString', '<b>Buku tidak terdaftar.</b>', $output);
