...
if (strlen($search_string) >= 1 && $search_string !== ' ') {
	// Build Query
	$query = 'SELECT * FROM members WHERE nama LIKE "%'.$search_string.'%" OR id LIKE "%'.$search_string.'%"';
	...
	if (isset($result_array)) {
		foreach ($result_array as $result) {
			...
			$display_name = preg_replace("/".$search_string."/i", "<b class='highlight'>".$search_string."</b>", $result['nama']);
