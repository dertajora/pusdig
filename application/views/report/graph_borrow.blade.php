...
$(function () {
        $('#container1').highcharts({
            ...
            title: {
                text: 'Rincian Peminjaman Bulanan Perpustakaan Bina Tunas'
            },
            subtitle: {
            ...
            yAxis: {
                title: {
                    text: 'Banyaknya peminjaman (buku)'
                }
            },
            tooltip: {
                enabled: false,
...
<table class="table "><tr>
  <td>
     <a data-toggle="modal" href="/reports/aktivitas" class="btn btn-success">
  ...
  <table class="table-hover">
   ...
   <tr><td><b>Peminjaman Tahun </b></td><td><?php echo"<b>"; echo $tahun; echo"</b>";?></td></tr></b>
   ...
   <tr><td><b>Total peminjaman tahun ini </b></td><td><?php echo"<b>"; echo $total; echo"</b>";?></td> </tr>
  </table>
</td>
<td>
<br>
